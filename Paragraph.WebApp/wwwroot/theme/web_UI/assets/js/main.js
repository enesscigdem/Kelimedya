(function ($) {
  ...
  */
  ...
  --------------------------------------------------------------*/
  function accordian() {
    $('.td_accordion').children('.td_accordion_body').hide();
    $('.td_accordion.active').children('.td_accordion_body').show();
    $('.td_accordion_head').on('click', function () {
      $(this)
        .parent('.td_accordion')
        .siblings()
        .children('.td_accordion_body')
        .slideUp(250);
      ...
      $(this)
        ...
        .parent()
        .siblings()
        .find('.td_accordion_body')
        .slideUp(250);
      /* Accordian Active Class */
      $(this).parents('.td_accordion').addClass('active');
      $(this).parent('.td_accordion').siblings().removeClass('active');
    });
  }
