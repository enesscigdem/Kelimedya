            ...
            if (dto.GameQuestions != null && dto.GameQuestions.Any())
            {
                foreach (var q in dto.GameQuestions)
                {
                    _context.WordCardGameQuestions.Add(new WordCardGameQuestion
                    {
                        ...
                        AnswerText = string.IsNullOrWhiteSpace(q.AnswerText) ? null : q.AnswerText,
                        ImageUrl = q.ImageFile != null ? await SaveFileAsync(q.ImageFile, "question-images") : q.ImageUrl,
                        ImageUrl2 = q.ImageFile2 != null ? await SaveFileAsync(q.ImageFile2, "question-images") : q.ImageUrl2,
                        ImageUrl3 = q.ImageFile3 != null ? await SaveFileAsync(q.ImageFile3, "question-images") : q.ImageUrl3,
                        ImageUrl4 = q.ImageFile4 != null ? await SaveFileAsync(q.ImageFile4, "question-images") : q.ImageUrl4,
