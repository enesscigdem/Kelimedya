    ...
    public partial class AddQuizQuestions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseFinalQuestions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentGameStatistics", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordCardGameQuestions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "WordCardTestQuestions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordCardTestQuestions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCourses", x => new { x.ProductId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_ProductCourses_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCourses_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearnedWordCardsCount = table.Column<int>(type: "int", nullable: false),
                    ...
                    TotalTimeSpentSeconds = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WordCards_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "StudentWordCardProgresses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ResponseTimeTotalSeconds = table.Column<double>(type: "float", nullable: false),
                    AverageResponseTimeSeconds = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentWordCardProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentWordCardProgresses_WordCards_WordCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseFinalQuestions_IsDeleted",
                table: "CourseFinalQuestions",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCourses_CourseId",
                table: "ProductCourses",
                column: "CourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGameStatistics_IsDeleted",
                table: "StudentGameStatistics",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_StudentLessonProgresses_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentQuizResults_IsDeleted",
                table: "StudentQuizResults",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_StudentWordCardProgresses_IsDeleted",
                table: "StudentWordCardProgresses",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_StudentWordCardProgresses_WordCardId",
                table: "StudentWordCardProgresses",
                column: "WordCardId");

            migrationBuilder.CreateIndex(
                name: "IX_Widgets_IsDeleted",
                table: "Widgets",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_WordCardGameQuestions_IsDeleted",
                table: "WordCardGameQuestions",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_WordCards_IsDeleted",
                table: "WordCards",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_WordCards_LessonId",
                table: "WordCards",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_WordCardTestQuestions_IsDeleted",
                table: "WordCardTestQuestions",
                column: "IsDeleted");
